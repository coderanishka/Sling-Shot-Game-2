...
function setup(){
 ...
 block1= new Ground(110,330,5,252);
 
 sling = new Sling(pbox.body,{x:130,y:180});
}
...
function draw(){
    ...
    textSize(30);
    fill(220,100,255);
    text("Pick It - Drag It - Shoot It !!",200,50);
